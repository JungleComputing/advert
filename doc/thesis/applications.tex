...
Engine AdvertService Adaptor.\label{related-gat-design}}
\end{center}
\end{figure*}
...
As of yet, only a local implementation of the AdvertService exists (i.e. )
...
At first, it seems that this solution introduces a lot more typing.